...
export class HaPanelLogbook extends LitElement {
  ...
  private _clearAll() {
    this._clearFilters();
    // Also puts the time range back to its default; this replaced the old
    // app bar reset button.
    this._resetLogbook();
  }
  ...
  static get styles() {
    return [
      ...
      css`
        ...
        ha-top-app-bar-fixed {
          /* Same lane a dashboard uses, so this page is not full width */
          --ha-top-app-bar-content-max-width: var(--ha-page-max-width, 1628px);
        }
        ...
        .content {
          ...
          width: 100%;
          max-width: var(--ha-page-max-width, 1628px);
          margin: 0 auto;
          height: calc(
