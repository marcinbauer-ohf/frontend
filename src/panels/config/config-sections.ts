...
// Devices, automations, areas, and people are each a group of top-level
// settings pages that also share a tab bar when you're inside one of them.
// The dashboard lists every page in the group directly instead of the one
// entry point it used to have, so there's no extra nested page to land on.
const devicesPages: PageNavigation[] = [
  {
...
const automationsPages: PageNavigation[] = [
  {
...
const areasPages: PageNavigation[] = [
  {
    component: "areas",
    path: "/config/areas",
...
const personsPages: PageNavigation[] = [
  {
    component: "person",
    path: "/config/person",
...
const generalPages: PageNavigation[] = [
  {
    path: "/config/general",
    translationKey: "core",
    iconPath: mdiCog,
...
export const configSections: Record<string, PageNavigation[]> = {
  ...
  persons: personsPages,
  areas: areasPages,
  general: generalPages,
  about: [
    {
      component: "info",
      path: "/config/info",
